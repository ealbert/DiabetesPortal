...
<article id="PatientSummary" class="body">
    <header>
        ...
        <h2>Telephone Encounter (Injections) - Call <?php echo $_GET[callType] ?></h2>
        ...
        <form id="reviewForm" action="../patientDetails/patientDetails.php" method="post">
            <fieldset>
                ...
                <div id="reviewMenu"class="jqueryslidemenu">
                    <ul>
                        <li><a href="#" onclick="showForm(event, 'doc_injection_doses')" class="currentForm">Injection Doses</a></li>
            ...
            <fieldset id="doc_injection_doses" class="reviewSubForm">
                <?php require('doc_injection_doses.php');?>
            </fieldset>
